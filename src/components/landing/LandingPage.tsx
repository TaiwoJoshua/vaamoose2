        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          ...
          >
            <div className="relative">
              <div className="flex items-center bg-white rounded-2xl shadow-xl border border-slate-200 p-2">
                ...
                <Button
                  ...
                  className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-6 rounded-xl font-semibold"
                >
                  Find Your Ride
